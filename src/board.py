...
def build(
    ...
    # `board_rank` is computed and kept whether or not the blend ran. It is the
    # unblended control that makes `compare_footballers` a real comparison rather
    # than a restatement — the same reason `compare_baselines` exists.
